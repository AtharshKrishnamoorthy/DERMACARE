...
import { ScanEye, Eye, EyeOff, Loader2 } from "lucide-react";
...
import { signIn } from "@/api/services/auth/auth";
...
export default function SignInPage() {
  ...
  const set = (field: keyof SigninForm) => (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <DottedBackground className="flex min-h-screen items-center justify-center px-4 py-12">
      ...
      >
        <Card className="border-border/60 shadow-xl shadow-primary/5">
          <CardHeader className="items-center px-5 pt-6 text-center sm:px-10 sm:pt-10">
            ...
            <CardDescription>
              Sign in to your DermaCare account
            </CardDescription>
          </CardHeader>

          <CardContent className="flex flex-col gap-6 px-5 pb-4 sm:px-10">
            {/* OAuth buttons */}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <Button type="submit" className="mt-2 w-full h-11 text-base font-medium" disabled={loading}>
                {loading ? (
                  <>
          ...
          <CardFooter className="justify-center px-5 pb-8 pt-4 sm:px-10 sm:pb-10 sm:pt-6">
